...
@Component({
  selector: 'app-gest-personnel',
  imports: [ImportedModule,HomeTemplateComponent,RouterOutlet],
  templateUrl: './gest-personnel.component.html',
  styleUrl: './gest-personnel.component.scss'
})
export class GestPersonnelComponent implements OnInit {
